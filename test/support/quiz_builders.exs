defmodule QuizBuilders do
  defmacro __using__(_options) do
    quote do
      alias Mastery.Core.{Template, Question, Quiz, Response}
      ...
      def addition_checker(subsitutions, answer) do
        left = Keyword.fetch!(subsitutions, :left)
        right = Keyword.fetch!(subsitutions, :right)
